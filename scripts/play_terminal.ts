...
type GameInterface = "Random" | "Terminal";
...
async function main(): Promise<void> {
  ...
  const gameInterfaces = ["Random", "Terminal"] satisfies Array<GameInterface>;
...
async function createGame(gameInterface: GameInterface) {
  ...
  if (!settings.numberOfPlayers || typeof settings.numberOfPlayers !== "number") {
